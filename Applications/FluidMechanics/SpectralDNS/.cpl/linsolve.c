...
extern void spectraldns_14buildrhs(void (*timescheme_)(struct COMPLEX_ *rhs_,const int old_l,const int old_h,const ssize_t old_i,char *old__,double unknown_REAL,double unknown_IMAG,double implicit_part_REAL,double implicit_part_IMAG,double explicit_part_REAL,double explicit_part_IMAG));
...
void linsolve_10deriv(const int f0_l,const int f0_h,const ssize_t f0_i,char *f0__,const int f1_l,const int f1_h,const ssize_t f1_i,char *f1__){{struct freefunc* es=freestack;
   ...
   {int i_=1  ;do{{ {struct _spectraldns_s6 *_11w;
_11w=(struct _spectraldns_s6 *)(i_*_spectraldns_s6_s+derivatives_) ;
(*(double *)(i_*f1_i+f1__))=(  (*(double *)((-2)*(ssize_t)sizeof(double)+(*_11w).d1_-spectraldns_7st))*(*(double *)((-2)*f0_i+(i_*f0_i+f0__)))+(*(double *)(-(ssize_t)sizeof(double)+(*_11w).d1_-spectraldns_7st))*(*(double *)(-f0_i+(i_*f0_i+f0__)))+(*(double *)((*_11w).d1_-spectraldns_7st))*(*(double *)((i_*f0_i+f0__)))+(*(double *)((ssize_t)sizeof(double)+(*_11w).d1_-spectraldns_7st))*(*(double *)(f0_i+(i_*f0_i+f0__)))+(*(double *)(2*(ssize_t)sizeof(double)+(*_11w).d1_-spectraldns_7st))*(*(double *)(2*f0_i+(i_*f0_i+f0__)))) ;}}i_+=1;}while(i_<=ny_-1);}
...
double _19i_17ibeta;
double _20k2;
_12r=alfa0_*(double)(ix_);
_14r_13ialfa=0.;
_15i_13ialfa=_12r;
/*ialfa=_14r_13ialfa,_15i_13ialfa*/  _16r=beta0_*(double)(iz_);
_18r_17ibeta=0.;
_19i_17ibeta=_16r;
/*ibeta=_18r_17ibeta,_19i_17ibeta*/
  _20k2=((alfa0_*(double)(ix_))*(alfa0_*(double)(ix_)))+((beta0_*(double)(iz_))*(beta0_*(double)(iz_)));
 
   {int iy_=1  ;while(iy_<=ny_-1 ){  {int i_=(-2);do{ {
    struct _spectraldns_s6 *_21w;
_21w=(struct _spectraldns_s6 *)(iy_*_spectraldns_s6_s+derivatives_);
(*(double *)(i_*(ssize_t)sizeof(double)+iy_*(ssize_t)sizeof(double)*(2-(-2)+1)+D2vmat_))=lambda_*((*(double *)(i_*(ssize_t)sizeof(double)+(*_21w).d2_-spectraldns_7st))-_20k2*(*(double *)(i_*(ssize_t)sizeof(double)+(*_21w).d0_-spectraldns_7st)))-(ni_*((*(double *)(i_*(ssize_t)sizeof(double)+(*_21w).d4_-spectraldns_7st))-2.*_20k2*(*(double *)(i_*(ssize_t)sizeof(double)+(*_21w).d2_-spectraldns_7st))+_20k2*_20k2*(*(double *)(i_*(ssize_t)sizeof(double)+(*_21w).d0_-spectraldns_7st))));
    (*(double *)(i_*(ssize_t)sizeof(double)+iy_*(ssize_t)sizeof(double)*(2-(-2)+1)+etamat_))=lambda_*(*(double *)(i_*(ssize_t)sizeof(double)+(*_21w).d0_-spectraldns_7st))-(ni_*((*(double *)(i_*(ssize_t)sizeof(double)+(*_21w).d2_-spectraldns_7st))-_20k2*(*(double *)(i_*(ssize_t)sizeof(double)+(*_21w).d0_-spectraldns_7st)))) ;
  }i_++;}while(i_<=2);}iy_+=1;}}
  /* condizioni al contorno */
  memmove(spectraldns_7st+D2vmat_,spectraldns_7st+d040_-((-2)*(ssize_t)sizeof(double)),(ssize_t)sizeof(double)*(2-(-2)+1));  memmove(spectraldns_7st-(ssize_t)sizeof(double)*(2-(-2)+1)+D2vmat_,spectraldns_7st+d140_-((-2)*(ssize_t)sizeof(double)),(ssize_t)sizeof(double)*(2-(-2)+1));
  memmove(spectraldns_7st+ny_*(ssize_t)sizeof(double)*(2-(-2)+1)+D2vmat_,spectraldns_7st+d04n_-((-2)*(ssize_t)sizeof(double)),(ssize_t)sizeof(double)*(2-(-2)+1));  memmove(spectraldns_7st+(ny_+1)*(ssize_t)sizeof(double)*(2-(-2)+1)+D2vmat_,spectraldns_7st+d14n_-((-2)*(ssize_t)sizeof(double)),(ssize_t)sizeof(double)*(2-(-2)+1));
  memmove(spectraldns_7st+etamat_,spectraldns_7st+d040_-((-2)*(ssize_t)sizeof(double)),(ssize_t)sizeof(double)*(2-(-2)+1));  memmove(spectraldns_7st-(ssize_t)sizeof(double)*(2-(-2)+1)+etamat_,spectraldns_7st+(*(struct _spectraldns_s6*)(_spectraldns_s6_s+derivatives_)).d4_-spectraldns_7st,(ssize_t)sizeof(double)*(2-(-2)+1));
  memmove(spectraldns_7st+ny_*(ssize_t)sizeof(double)*(2-(-2)+1)+etamat_,spectraldns_7st+d04n_-((-2)*(ssize_t)sizeof(double)),(ssize_t)sizeof(double)*(2-(-2)+1));  memmove(spectraldns_7st+(ny_+1)*(ssize_t)sizeof(double)*(2-(-2)+1)+etamat_,spectraldns_7st+(*(struct _spectraldns_s6*)((ny_-1)*_spectraldns_s6_s+derivatives_)).d4_-spectraldns_7st,(ssize_t)sizeof(double)*(2-(-2)+1));
...
ucor_=malloc(_27i);if(ucor_==NULL)ucor_=errmalloc();ucor_-=spectraldns_5st;atblockexit(ucor_f,free,ucor_+spectraldns_5st); {int iy_=1  ;do{{ (*(double *)(iy_*(ssize_t)sizeof(double)+ucor_))=1.;}iy_+=1;}while(iy_<=ny_-1);}
...
_29m=(meanflowx_-spectraldns_11yintegr((-1),convolutions_2h,VELOCITY_s,(char*)&(*(struct COMPLEX_ *)(&(*(struct VELOCITY_ *)(_22w)).u_)).REAL_))/spectraldns_11yintegr((-1),_26h,(ssize_t)sizeof(double),ucor_);
...
_32m=(meanflowz_-spectraldns_11yintegr((-1),convolutions_2h,VELOCITY_s,(char*)&(*(struct COMPLEX_ *)(&(*(struct VELOCITY_ *)(_22w)).v_)).REAL_))/spectraldns_11yintegr((-1),_26h,(ssize_t)sizeof(double),ucor_);
...
double _41i;
double _42r;
_34r=((_14r_13ialfa*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).w_)).REAL_-_15i_13ialfa*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).w_)).IMAG_)-(_18r_17ibeta*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).u_)).REAL_-_19i_17ibeta*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).u_)).IMAG_));
_35i=((_14r_13ialfa*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).w_)).IMAG_+_15i_13ialfa*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).w_)).REAL_)-(_18r_17ibeta*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).u_)).IMAG_+_19i_17ibeta*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).u_)).REAL_));
_36r=(1./(_20k2));
_38r_37temp=(_34r*_36r);
_39i_37temp=(_35i*_36r);
/*temp=_38r_37temp,_39i_37temp*/
      _40r=((_18r_17ibeta*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).w_)).REAL_-_19i_17ibeta*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).w_)).IMAG_)+(_14r_13ialfa*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).u_)).REAL_-_15i_13ialfa*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).u_)).IMAG_));
_41i=((_18r_17ibeta*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).w_)).IMAG_+_19i_17ibeta*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).w_)).REAL_)+(_14r_13ialfa*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).u_)).IMAG_+_15i_13ialfa*(*(struct COMPLEX_*)(iy_*VELOCITY_s+(char*)&(*(struct VELOCITY_*)(_22w)).u_)).REAL_));
_42r=(1./(_20k2 ));
